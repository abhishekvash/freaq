...
<template>
	...
	>
		...
		>
			...
			<span
				ref="scanlineRef"
				class="landing-hero-scanline pointer-events-none absolute inset-0 overflow-hidden motion-reduce:hidden"
				aria-hidden="true"
			/>
		</span>
	</h1>
...
.landing-hero-scanline::before {
	content: "";
	position: absolute;
	top: 4%;
	bottom: 4%;
	left: var(--landing-hero-scan-x);
	width: 4px;
